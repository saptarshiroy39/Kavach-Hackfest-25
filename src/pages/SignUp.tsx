          ...
          <div className={`rounded-lg ${isLightTheme ? 'bg-blue-500/5 border border-blue-200' : 'bg-sidebar-accent'} p-6 space-y-4`}>
            <div className="flex items-start">
              ...
              <div className="ml-3">
                ...
                <p className={`mt-1 text-xs ${isLightTheme ? 'text-blue-600' : 'text-sidebar-foreground/70'}`}>Your data is encrypted and only accessible by you</p>
              </div>
            </div>
            <div className="flex items-start">
              <div className="flex-shrink-0">
              ...
              <div className="ml-3">
                ...
                <p className={`mt-1 text-xs ${isLightTheme ? 'text-blue-600' : 'text-sidebar-foreground/70'}`}>Use your fingerprint or face for secure access</p>
              </div>
            </div>
            <div className="flex items-start">
              <div className="flex-shrink-0">
              ...
              <div className="ml-3">
                ...
                <p className={`mt-1 text-xs ${isLightTheme ? 'text-blue-600' : 'text-sidebar-foreground/70'}`}>Secure across all your devices and platforms</p>
              </div>
            </div>
          </div>
        </div>
